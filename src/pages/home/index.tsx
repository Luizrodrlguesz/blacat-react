...
const Home = () => {
  ...
  const relatedProducts = [
    {
      img: "/assets/shirt-b.webp",
      name: "Camiseta Esportiva DryFit",
      price: "R$120,00",
    },
    {
      img: "/assets/shirt-r.webp",
  ...
  return (
    <div>
      ...
      <div className=" video-container">
        ...
        >
          <source src="/assets/blacat-short-v.mp4" type="video/mp4" />
      ...
      <div className="container">
        <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 ">
          <div className="col">
            <Link href="/product-details" className="text-decoration-none">
              <div className="card shadow-sm">
                <img
                  src="/assets/shirt-w.jpeg"
                  className="card-img-top"
                  alt="Camiseta T-Shirt Basica Blacat Oversized"
                />
                <div className="card-body">
                  <h5 className="card-title">Camiseta T-Shirt Básica Oversized</h5>
                  <div className="tags">
                    <span className="tag">Casual</span>
                    <span className="tag">Confortável</span>
                    <span className="tag">Unissex</span>
                  </div>
                  <div className="pricing-info">
                    <span className="price">R$100,00</span>
                    <span className="discount">+10% OFF no Pix</span>
                  </div>
      ...
      <p className="mb-5 mt-5 ms-5 me-5 text-message-home">
