  ...
  return (
    <div>
      <div className="male-content">
        <div className="male-title">
          <h1 className="male-title__content t4desktop-Helvetica t4mobile-Helvetica">
            Masculino
          </h1>
        </div>
        <ul className="male-content__lista">
          <li className="male-content__lista-item">
            <a
              href="#"
              data-bannerposition="topmenu"
              className="male-content__lista-link"
            >
              Roupas Casuais
            </a>
          </li>
